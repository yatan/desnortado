...
<div class="nav-container-outer">
  ...
  <ul id="nav-container" class="nav-container">
      ...
      <li><a class="item-primary" href="#" target="_self"><?php echo getString('militar'); ?></a>
         <ul style="width:150px;">
            <li><a href="<?phpphp echo "/".$_GET['lang']."/entrenar"; ?>" title="Entrenamiento" target="_self" ><?php echo getString('entrenamiento'); ?></a></li>
      ...
      <li><a class="item-primary" href="#" target="_self"><?php echo getString('soporte'); ?></a>
       ...
       <li><span class="divider divider-vert" ></span></li>
      <li><a class="item-primary" href="/logout" target="_self"><?phpecho getString('logout');?></a>
	   </li>
       <li><span class="divider divider-vert" ></span></li>
      <li class="clear">&nbsp;</li>
   </ul>
